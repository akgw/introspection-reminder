...
export class sheetDataToAssessmentsService {
  ...
  public execute(): Assessment[] {
    ...
    this.sheetData.map(row => {
      const [jan, name, images, manufacturer, category, appraisal, maxAppraisal, newAppraisal, condition3Appraisal, condition5Appraisal, condition6Appraisal, isDeleted, isOneprice, isManual] = row;
